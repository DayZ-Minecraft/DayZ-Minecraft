...
public class BiomeSnow extends BiomeGenBase {
  ...
  public BiomeSnow(int id, boolean isMountains) {
    super(id);
    setColor(747097);
    setBiomeName("Forest");
    temperature = BiomeGenBase.iceMountains.temperature;
    rainfall = BiomeGenBase.iceMountains.rainfall;
    setHeight(isMountains ? height_HighPlateaus : height_LowPlains);
