...
public class GenLayerDayZOcean1 extends GenLayer {
  ...
  public GenLayerDayZOcean1(long l, GenLayer genlayer, IWorldType worldType) {
    super(l);
    parent = genlayer;
    ...
    for (int i1 = 0; i1 < par4; i1++) {
      for (int j1 = 0; j1 < par3; j1++) {
        ...
        if (k2 == 0 && (k1 != 0 || l1 != 0 || i2 != 0 || j2 != 0)) {
          ...
          BiomeGenBase ocean;
          if (i3 >= 0) {
            ocean = worldType.setOceanBiomes(BiomeGenBase.getBiomeGenArray()[i3], this);
          } else {
        ...
        if (k2 > 0 && (k1 == 0 || l1 == 0 || i2 == 0 || j2 == 0)) {
          if (nextInt(5) == 0) {
            BiomeGenBase ocean = worldType.setOceanBiomes(BiomeGenBase.getBiomeGenArray()[k2], this);
            if (ocean != null) {
              ai1[j1 + i1 * par3] = ocean.biomeID;
            }
          } else {
